...
Reopened: needs to work for multiselection with shift-click.
...
```bash
svn diff web/mkt-3.0/app/view/abm/namedAccount/Toolbar.js web/mkt-3.0/app/controller/abm/namedAccount/Toolbar.js web/mkt-3.0/resources/sass/widgets/_abmIncludeChildrenPanel.scss web/mkt-3.0/resources/css/* > LM-106007.patch
# Patch to INT
